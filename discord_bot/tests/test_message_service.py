...
class TestMessageService:
    ...
    def test_add_dm_message(self, service):
        ...
        service.add_to_history(
            message_type="dm", content="Hello bot!", user_id="123456789", username="testuser", message_id="msg_001"
        )
    ...
    def test_message_auto_id_generation(self, service):
        ...
        service.add_to_history(message_type="dm", content="Test message", user_id="123", username="user")
    ...
    def test_get_history_no_filters(self, service):
        ...
        for i in range(5):
            service.add_to_history(
                message_type="dm", content=f"Message {i}", user_id="123", username="user", message_id=f"msg_{i}"
            )
    ...
    def test_timestamp_format(self, service):
        ...
        service.add_to_history(message_type="dm", content="Test", user_id="123", username="user")
